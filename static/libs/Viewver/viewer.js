...
(function (factory) {
  ...
  Viewer.prototype = {
    ...
    build: function () {
      ...
      this.$nextbtn = $nextbtn = $viewer.find('.viewer-next');
      this.$prebtn = $prebtn = $viewer.find('.viewer-prev');
      ...
      if(!options.tabable){
        $nextbtn.addClass(CLASS_HIDE)
        $prebtn.addClass(CLASS_HIDE)
        $toolbar.addClass("viewer-70")
      }
